...
// Typed routes are generated by the dev server, so new routes are cast until it runs.
const blocks: Array<{ href: Href; title: string }> = [
  ['sign-in', 'Sign in'],
  ['sign-up', 'Sign up'],
  ...
  return (
    <Screen>
      ...
      <Section title="Blocks">
        {blocks.map((b) => (
          <Link key={b.title} href={b.href} asChild>
